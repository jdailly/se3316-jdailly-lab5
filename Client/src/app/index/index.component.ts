...
export class IndexComponent implements OnInit {
 ...
 product;
  ...
  //   var wishID=this.getID(event);//getting the id of the product
  //   var wishDes;//holds the item description 
  //   var wishName;//holds the item name
  //   var existUser=false;// used to check
